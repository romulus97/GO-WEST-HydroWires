        ...
        for UC in UC_TREATMENTS:
            ...
            for T_p in line_limit_scaling:
                ...
                for BA_hurd in BA_hurdle_scaling:
                    ...
                    path=str(Path.cwd()) + str(Path('/Simulation_folders_PERSISTENCE/Exp' + str(y) + '_' + str(NN) + UC + '_' + str(T_p) + '_' + str(BA_hurd)))
                    ...
                    df_hydro_ts = pd.read_csv('2000_2019_weekly_GOWEST_hydro_inputs_PERSISTENCE.csv',header=0)
                    new_hydro_nodes = []
                    ...
                    df_hydro.to_csv('EIA_bus_match.csv')
